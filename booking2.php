...
<rscript src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    ...
    <section class="w3l-contacts-12">
        <div class="wrapper">
            <h5 class="heading">Service Detail</h5>
            
            <div class="contacts12-main">
                <form method="post">
                    <div class="main-input">
                    <input type="text" name="category" value="<?php echo  $catg?>" class="contact-input1"
                            readonly><br>
                            <select placeholder="Please Select Sub Service" class="contact-input1">
        <option><?php echo $subcatg ?></option>
        
      </select><br>
      <select  placeholder="Please Select Quantity" name="quantity" class="contact-input1">
        <option>1</option>
        <option>2</option>
        <option>3</option>
        <option>4</option>
                    ...
                    <!--input type="text" name="iss" class="form-control datepicker contact-input1" autocomplete="off" placeholder="Select your booking date"--><br>
                       ...
                       <button type="submit" name="sub" class="actionbg">Next</button>
                </form>
            </div>
        </div>
    </section>
