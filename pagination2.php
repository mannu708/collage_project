  ...
  <body>   
	  <center>  
	    ...
	    // Import the file where we defined the connection to Database.     
	        require_once "admin/tables/db_connect.php";   
...
<table class="table table-striped table-condensed    	                                          table-bordered">   
	    ...
	    echo "</br>";     
	        ...
	        if($page>=2){   
	            echo "<a href='pagination2.php?page=".($page-1)."'>  Prev </a>";   
	        }       
	                   
	        for ($i=1; $i<=$total_pages; $i++) {   
	          if ($i == $page) {   
	              $pagLink .= "<a class = 'active' href='pagination2.php?page="  
	                                                .$i."'>".$i." </a>";   
          }               
	          else  {   
	              $pagLink .= "<a href='pagination2.php?page=".$i."'>   
	                                                ".$i." </a>";     
	          }   
        };     
	        echo $pagLink;   
	  ...
	  <script>  
	    ...
	    {   
	        ...
	        window.location.href = 'pagination2.php?page='+page;   
	    }   
	  </script>  
	  </body>   
	</html>  
